...
Wassily is an open project. If you find an error in the data, a broken derivation, or a sector that doesn't add up, please open an issue or pull request. The goal is a resource the community can rely on — and that means it needs to be correctable.
